...
INSERT INTO MASCOTAS (NOMBRE, EDAD, SEXO, COLOR, RAZA, PESO, ALTURA, FOTO, CREACION, ACTUALIZACION) VALUES (PNOMBRE, PEDAD, PSEXO, PCOLOR, PRAZA, PPESO, PALTURA, PFOTO, NOW(), NOW());
...
UPDATE MASCOTAS SET NOMBRE=PNOMBRE, EDAD=PEDAD, SEXO=PSEXO, COLOR=PCOLOR, RAZA=PRAZA, PESO=PPESO, ALTURA=PALTURA, FOTO=PFOTO, ACTUALIZACION=NOW() WHERE ID=PID;
...
INSERT INTO CITAS (RECEPCIONISTA, VETERINARIO, CLIENTE, MASCOTA, ATENCION, FECHA, CREACION, ACTUALIZACION) 
VALUES (PRECEPCIONISTA, PVETERINARIO, PCLIENTE, PMASCOTA, PATENCION, PFECHA, NOW(), NOW());
...
UPDATE CITAS SET RECEPCIONISTA=PRECEPCIONISTA, VETERINARIO=PVETERINARIO, CLIENTE=PCLIENTE, MASCOTA=PMASCOTA, ATENCION=PATENCION, FECHA=PFECHA, ACTUALIZACION=NOW() WHERE ID=PID;
